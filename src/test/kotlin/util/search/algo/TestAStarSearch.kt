...
//import util.graph.CorridorGenerationGraph
...
//    @MockK
//    lateinit var searcher: AStarSearch
//
//    @BeforeEach
//    fun initSearcher() {
...
//
//        val graph = spyk(CorridorGenerationGraph(matrix, listOf()))
//        every { graph.initMap() } answers {
//            with(graph) {
//                this.also { this.initMap() }
//            }
//        }
//        searcher.map = graph
//    }
